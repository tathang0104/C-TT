            ...
            <div className="container py-5">
                <div className="row g-5">
                    <div className="col-lg-3 col-md-6">
                        ...
                        <a className="btn btn-link" href="reservation">Reservation</a>
                ...
                <div className="copyright">
                    <div className="row">
                        <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a className="border-bottom" href="site">Your Site Name</a>, All Right Reserved. 
							
							Designed By <a className="border-bottom" href="https://htmlcodex.com">HTML Codex</a><div></div>
                            Distributed By <a className="border-bottom" href="https://themewagon.com" target="blank">ThemeWagon</a>
                        </div>
